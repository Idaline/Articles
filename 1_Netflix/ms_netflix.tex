...
abundances %L'utilisation des abondances n'est pas une technique, elle sert pour une technique, analyses mutlivariées...?
...
real food webs %based on species niche ? Pareil pour l'autre, comment utilisent-ils les abondances ?
...
interactions. 
%Tu peux donner un exemple en disant, que ça permet de connaitre les effets en cascade que pourrait probablement produire une perturbaiton
...
%C'est quand même important de dire que les data viennent de food webs de sols incluant invertébrés, plantes, détritus, bactéries, champignons. 
...
%La suite devrait aller dans les résultats
...
non-interactions. %La de la phrase d'avant me semble étrange.
...
%Je ne pense pas qu'on puisse qualifier cette food web en étant simple, mais il est supposé que les espèces du sol sont très opportunistes, et mangent toutes les espèces sur lesquelles elles tombes, et qu'elles sont physiquement capables de manger. D'où l'importance du bodymass.
